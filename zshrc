...
alias py37="source /opt/miniconda3/bin/activate py37"
alias py38="source /opt/miniconda3/bin/activate py38"
alias py10="source /opt/miniconda3/bin/activate py10"
